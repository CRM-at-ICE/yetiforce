...
{strip}
	<div class="pull-right actions">
		<span class="actionImages">
			{if $IS_EDITABLE)}
				<a class="showModal" data-url="{$RELATED_RECORD->getModalUrl()}"><span title="{vtranslate('LBL_SET_RECORD_STATUS', $MODULE)}" class="glyphicon glyphicon-ok alignMiddle"></span></a>&nbsp;
			{/if}
