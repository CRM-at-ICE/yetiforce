	...
	<div class="actions pull-right">
		<span class="actionImages">
			{if $IS_MODULE_EDITABLE}
				<a class="showModal" data-url="{$LISTVIEW_ENTRY->getModalUrl()}"><span title="{vtranslate('LBL_SET_RECORD_STATUS', $MODULE)}" class="glyphicon glyphicon-ok alignMiddle"></span></a>&nbsp;
			{/if}
